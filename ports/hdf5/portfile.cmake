...
# Android (arm64) cannot execute the target binaries HDF5's CMake TRY_RUN probes
# build, so seed those run-time detection results via a CMake initial-cache file.
# Prepended as the FIRST configure option so the seeded INTERNAL cache vars exist
# before HDF5's checks run. Guarded to the Android triplet ONLY: an unconditional
# seed would override Linux's native try_run detection and change the Linux build.
set(H5_CROSS_SEED_OPTION "")
if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Android")
    set(H5_CROSS_SEED_OPTION "-C${CURRENT_PORT_DIR}/h5cross-seed.cmake")
endif()
